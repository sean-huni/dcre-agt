 ...
 *  M10/SCRUM-79 adds the Mandates family: MRR->MRV->MAF->MIT->{MIR,MRW} on
 ...
 *
 *  <p>MAR, MSR and MIS are RETAINED-DEPRECATED (A-75): agt_ops.stage_outcome.stage is
...
public enum Stage {
    ...
    MRR, MRV, MAF, MIT, MIR, MRW, MIX, MSX, MPX, MRG,
